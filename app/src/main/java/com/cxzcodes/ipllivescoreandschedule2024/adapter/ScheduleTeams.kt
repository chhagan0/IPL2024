...
class ScheduleTeams(private val items: List<ModelClass>, val context: Context) :
    RecyclerView.Adapter<ScheduleTeams.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = android.content.Intent(context, MatchActivity::class.java)
